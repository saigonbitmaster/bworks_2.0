...
export declare type PostJobDocument = PostJob & Document;
export declare class PostJob {
    name: string;
    employerId: string;
    expireDate: Date;
    expectDate: string;
...
declare const PostJobSchema: import("mongoose").Schema<PostJob, import("mongoose").Model<PostJob, any, any, any, any>, {}, {}, {}, {}, "type", PostJob>;
