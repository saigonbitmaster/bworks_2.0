...
let SkillService = class SkillService {
    ...
    async create(createSkillDto) {
        ...
        return await new this.model(Object.assign(Object.assign({}, createSkillDto), { createdAt: new Date(), employeeId: employeeId })).save();
    }
...
SkillService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(schema_1.Skill.name)),
